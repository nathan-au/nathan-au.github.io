const projects = [
    {
        ...
        git_repo: "https://github.com/nathan-au/scaffold"   
    },
    {
        name: "Reel Digest",
...
projects.forEach(project => {
    ...
    let imageHTML = "<figure><img src=\"" + project.image_path + "\" alt=\"" + project.name + "\" /></figure>"
    ...
    projectCard.innerHTML = `
        ...
        <div class="card-body">
            ...
            <!-- <div class="opacity-80 flex gap-2.5 flex-wrap">${techStackHTML}</div> -->
            <div class="card-actions mt-5 justify-end">
                <a href="${project.git_repo}" target="_blank" class="btn bg-black text-white border-black opacity-90">
                    ${githubLogoSVG}
